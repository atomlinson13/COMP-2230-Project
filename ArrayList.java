...
//This code is intended to create an array list which becomes the parent class to ArrayUnordered list. It
// includes the methods to  create an array, expand its capacity, remove the last, first, and any element 
// within the list by finding it. It also returns the first and last element in the list as well as a contains
// method that returns a boolean value for if the given element is in the array. It also has the find, isEmpty, 
// toString, and size methods. The ArrayList.java class also implements the iterable interface and it's methods.
